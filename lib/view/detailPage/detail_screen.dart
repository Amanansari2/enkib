...
class _TutorDetailScreenState extends State<TutorDetailScreen> {
  ...
  Future<void> fetchTutorDetails(String slug) async {
    try {
      ...
      if (fetchedDetails['status'] == 404) {
        showCustomToast(context, '${fetchedDetails['message']}', false);
        showDialog(
          context: context,
          barrierDismissible: false,
          builder: (BuildContext context) {
                      ...
                      child: AppBar(
                        ...
                        leading: IconButton(
                          ...
                          icon: Icon(Icons.arrow_back_ios,
                              color: AppColors.greyColor(context), size: 20),
                          onPressed: () {
                            ...
                            Consumer<AuthProvider>(
                              builder: (context, authProvider, _) {
                                final isFavorite = authProvider
                                    .isTutorFavorite(widget.profile['id']);
                  ...
                  Text.rich(
                    TextSpan(
                      children: <TextSpan>[
                        ...
                        TextSpan(
                          text:
                          '/5.0 ($totalReviews ${Localization.translate("reviews")})',
                          style: TextStyle(
      ...
      child: ElevatedButton(
        onPressed: () {
          if (token == null) {
            ...
            print("Tutor profile data --->> ${widget.profile}");
            Navigator.push(
              context,
              MaterialPageRoute(
