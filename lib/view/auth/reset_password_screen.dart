        ...
        child: Scaffold(
          ...
          body: SafeArea(
            child: Column(
              children: [
                Align(
                  alignment: Localization.textDirection == TextDirection.rtl?Alignment.topLeft:Alignment.topRight,
                  child: Padding(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: SvgPicture.asset(
                              Localization.textDirection == TextDirection.rtl? AppImages.backArrow:AppImages.forwardArrow,
                              width: 15,
                              height: 15,
                              color: AppColors.greyColor(context),
                            ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  "Enter your registered email to securely reset your EnkiB account password and regain access instantly.",
                                  textScaler: TextScaler.noScaling,
                                  style: TextStyle(
                                    fontFamily: AppFontFamily.font,
                                ...
                                child: Container(
                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                      ...
                                      children: [
                                        TextSpan(
                                          text: Localization.translate('sign_in_now'),
                                          style: TextStyle(
                                            fontSize: FontSize.scale(context, 16),
                                            fontFamily: AppFontFamily.font,
                                            fontWeight: FontWeight.w500,
