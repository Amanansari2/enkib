...
class _CertificateDetailState extends State<CertificateDetail> {
  ...
  void initState() {
    ...
    authProvider.fetchCertificationList(token, tutorId!, context).then((_) {
      setState(() {
        _isFirstLoad = false;
      });
    }).catchError((e) {
                              ...
                              children: [
                                ...
                                TextField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: '${Localization.translate("certificate_title")}',
                                ...
                                TextField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText: '${Localization.translate("institute_title")}',
                                    labelStyle: TextStyle(
                                      fontSize: FontSize.scale(context, 16),
                                      color: AppColors.greyColor(context),
                                      fontFamily: AppFontFamily.font,
                                    ...
                                    try {
                                      ...
                                      if (token != null) {
                                        ...
                                        if (response['status'] == 200) {
                                          await authProvider
                                              .fetchCertificationList(token,
                                                  authProvider.userId!, context);
                                      ...
                                      Flexible(
                                        ...
                                        child: Container(
                                          ...
                                          child: certificate.imagePath != null &&
                                              certificate.imagePath!.isNotEmpty
                                              ? Image.network(
                                            Uri.encodeFull(certificate.imagePath!),
                                            fit: BoxFit.cover,
                                              ...
                                              child: RichText(
                                                text: TextSpan(
                                                  ...
                                                  children: <InlineSpan>[
                                                    ...
                                                    TextSpan(
                                                      text: '${Localization.translate("certificate_issued_text")}',
                                                      style: TextStyle(
                                                        fontFamily: AppFontFamily.font,
                                                        fontWeight: FontWeight.w400,
                                                        fontSize: FontSize.scale(context, 14),
                                              ...
                                              child: RichText(
                                                text: TextSpan(
                                                  ...
                                                  children: <InlineSpan>[
                                                    WidgetSpan(child: SizedBox(width: 5)),
                                                    TextSpan(
                                                      text: '${Localization.translate("certificate_expiry_text")}',
                                                      style: TextStyle(
                                                        fontFamily: AppFontFamily.font,
                                                        fontWeight: FontWeight.w400,
                                                        fontSize: FontSize.scale(context, 14),
