...
class _TutorCardState extends State<TutorCard> {
  ...
  Future<void> toggleFavorite(BuildContext context) async {
    ...
    try {
      ...
      if (token != null) {
        final response =
            await addDeleteFavouriteTutors(token, widget.tutorId, authProvider);

        if (response['status'] == 200) {
          showCustomToast(
              context, '${response['message']}', true);
          ...
          showCustomToast(
              context, response['message'] ?? 'Something went wrong', false);
        }
      }
        ...
        child: Stack(
          children: [
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Row(
                            mainAxisAlignment: Localization.textDirection == TextDirection.ltr
                      ...
                      Text.rich(
                        TextSpan(
                          children: <TextSpan>[
                            ...
                            TextSpan(
                              text: '/5.0 (${widget.reviews} ${Localization.translate("reviews")})',
                              style: TextStyle(
                          ...
                          Text.rich(
                            TextSpan(
                              children: <TextSpan>[
                                ...
                                TextSpan(
                                  text: (widget.activeStudents == null || widget.activeStudents.isEmpty || widget.activeStudents == '0' || widget.activeStudents == '1')
                                      ? "Student"
                  ...
                  Row(
                    children: [
                      SvgPicture.asset(AppImages.language, width: 14, height: 14),
                      SizedBox(width: 8),
                      Flexible(
                        child: Text.rich(
                          TextSpan(
            ...
            if (role == 'student')
                Positioned(
                  top: 25,
                  right: Localization.textDirection == TextDirection.ltr ? 12 : null,
                  left: Localization.textDirection == TextDirection.rtl ? 12 : null,
                  child: IconButton(
                    splashColor: Colors.transparent,
                    highlightColor: Colors.transparent,
                    onPressed: isLoadingFavorite ? null : () => toggleFavorite(context),
                    icon: isLoadingFavorite
                      ...
                      color: isFavorite ? AppColors.redColor : AppColors.greyColor(context),
                    ),
                  ),
                ),
            if (widget.deleteIcon)
              Positioned(
                top: 10,
                right: Localization.textDirection == TextDirection.ltr ? 15 : null,
                left: Localization.textDirection == TextDirection.rtl ? 15 : null,
                child: IconButton(
                  splashColor: Colors.transparent,
                  highlightColor: Colors.transparent,
