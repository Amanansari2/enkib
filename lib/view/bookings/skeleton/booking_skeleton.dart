        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              padding: EdgeInsets.only(right: Localization.textDirection == TextDirection.ltr?20.0:1.0),
              itemCount: 24,
                      ...
                      children: [
                        ...
                        Expanded(
                          child: hasBookingForThisSlot
                            ...
                            highlightColor: Colors.grey[100]!,
                            child: Padding(
                              padding: EdgeInsets.only(left: Localization.textDirection == TextDirection.rtl?12.0:0.0),
                              child: Container(
                                width: 300,
                                height: 40,
                                padding:
