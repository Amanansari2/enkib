  ...
  Future<Map<String, dynamic>> addCertificateToApi(
    ...
    try {
      ...
      if (response['status'] == 200) {
        ...
        throw Exception(response['message'] ?? '${Localization.translate("failed_certification")}');
      }
  ...
  Future<Map<String, dynamic>> updateCertificateToApi(
    ...
    try {
      ...
      if (response['status'] == 200) {
        ...
        throw Exception(response['message'] ?? Localization.translate("update_certification"));
      }
    } catch (e) {
      throw e;
    } finally {
