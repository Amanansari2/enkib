...
import '../../insights/component/custom_field.dart';
...
class _ExperienceDetailsScreenState extends State<ExperienceDetailsScreen> {
  ...
  void _openBottomSheet({
    ...
    if (experience != null) {
      ...
      _selectedCountryId =
          _countryMap.entries
              .firstWhere(
                (entry) => entry.value == experience.country,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  CustomField(
                                    ...
                                    labelText:
                                        '${Localization.translate("job_title")}',
                                    borderColor:
                                        _hasError &&
                                  ...
                                  CustomField(
                                    ...
                                    labelText:
                                        '${Localization.translate("company_name")}',
                                    borderColor:
                                        _hasError &&
                                  ...
                                  TextField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                          '${Localization.translate("employment_type")}',
  ...
  void _openEmploymentTypeBottomSheet(
    BuildContext context,
    StateSetter setModalState,
                        ...
                        child: SingleChildScrollView(
                          child: Container(
                            ...
                            child: Column(
                              ...
                              mainAxisSize: MainAxisSize.min,
                              children:
                                  _employmentTypeMap.entries.map((entry) {
                                    return Column(
                                      children: [
                                        _buildRadioTile(
                                          context: context,
  ...
  void _openCompanyTypeBottomSheet(
    BuildContext context,
    StateSetter setModalState,
    TextEditingController controller,
  ) {
                        ...
                        child: SingleChildScrollView(
                          child: Container(
                            ...
                            child: Column(
                              mainAxisSize: MainAxisSize.min,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: List.generate(_locationTypes.length, (
                                index,
                              ) {
              ...
              if (token != null) {
                try {
                  ...
                  if (response['status'] == 200) {
                    ...
                    await authProvider.fetchExperienceList(
                      token,
                      authProvider.userId!,
                      context,
                    );
                    ...
                    final message =
                        response['message'] ??
                        '${Localization.translate("experience_removed")}';
                    ...
                    final errorMessage =
                        response['message'] ??
                        "${Localization.translate("experience_delete_failed")}";
        ...
        body: Column(
          children: [
            ...
            if (_isFirstLoad)
              ...
              Container(
                height:
                    Platform.isIOS ? screenHeight * 0.09 : screenHeight * 0.1,
                decoration: BoxDecoration(
