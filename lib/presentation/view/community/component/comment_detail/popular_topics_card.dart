...
class PopularTopicsCard extends StatefulWidget {
  final String title;
  ...
  @override
  _PopularTopicsCardState createState() => _PopularTopicsCardState();
}

class _PopularTopicsCardState extends State<PopularTopicsCard> {
  bool showAdditionalImages = false;

  @override
  Widget build(BuildContext context) {
    final displayedImages = showAdditionalImages
        ? widget.imageUrls
        : widget.imageUrls.take(3).toList();

    double totalWidth = widget.imageUrls.isEmpty ? 0 : 40 + (widget.imageUrls.length - 1) * 18.0;
